...
import IRawPerson from "./IRawPerson";
import IRawOrganization from "./IRawOrganization";

export default interface IRawDeal {
    id?: number,
    creator_user_id?: IRawUser,
    user_id?: IRawUser,
    person_id?: IRawPerson,
    org_id?: IRawOrganization,
    stage_id?: number,
    title?: string,
    value?: number,
    currency?: string,
